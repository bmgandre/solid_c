...
void _free_financial_report_result(struct financial_report_result * financial_report_result) {
...
struct financial_report_result * _get_transactions(struct tm * begin, struct tm * end) {
